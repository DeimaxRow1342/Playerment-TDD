...
describe("Crear un programa gamificado para TDDLab metricas", () => {
  ...
  it("Debe devolver 16 pts para un commit con complejidad de Bueno", () => {
    const metrica = new Metrica();
  ...
  it("Debe devolver 8 pts para un commit con complejidad de Deficiente", () => {
    const metrica = new Metrica();
  ...
  it("Debe retornar 0 al calcular el puntaje por frecuencia", () => {
    const metrica = new Metrica();
    expect(metrica.calcularPuntajePorFrecuencia()).toEqual(0);
  })

  it("Debe retornar 20 puntos al tener una frecuencia menor o igual a 2 dias", () => {
    const metrica = new Metrica();
  ...
  it("Debe retornar 12 puntos al tener una frecuencia menor o igual a 7 dias y mayor o igual a 4 dias", () => {
    const metrica = new Metrica();
    expect(metrica.calcularPuntajePorFrecuencia(5)).toEqual(12);
  })
